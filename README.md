...
Актуальные плановые документы находятся в каталоге `plans/`:
- [Roadmap и этапы работ](plans/plan-roadmap.md)
- [Project Timeline](plans/plan-timeline.md)
- [План согласования и DoD](plans/plan-dod.md)
- [RACI и распределение ролей](plans/plan-raci.md)

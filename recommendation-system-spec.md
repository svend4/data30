...
### Уровни
1. **Prototype** — ограниченный функционал, низкая стабильность, публично доступен.
2. **Stable** — базовая функциональность закрывает ключевые сценарии, стабильность выше порога.
3. **Recommended** — высокий уровень стабильности, подтвержденная полезность, поддержка/документация.

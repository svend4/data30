...
## Рост каталога и зрелости

- Целевой размер каталога после MVP: 50+ приложений.
- Доля функций со статусом зрелости **stable/enterprise** — не ниже 30% от общего количества карточек.

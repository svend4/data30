...
## 6. Критический путь (ключевые задачи, непараллельная последовательность)
- Discovery: Формирование product backlog и roadmap.
- Design: Архитектурное проектирование.
- Development: Реализация ключевых фич (MVP).
- QA: Функциональное тестирование.
- Release: Деплой на прод.
